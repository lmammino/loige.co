...
In this article, I will illustrate the result of a small research I did about the history of Cloud computing from the age of *bare metal* to *serverless*.
...
![1989-1991 — Sir Tim Berners-Lee invented the World Wide Web](/content/images/2017/12/web-www-tim-berners-lee-from-bare-metal-to-serverless.jpg)
...
![1991-1995 — The bare metal age](/content/images/2017/12/server-racks-bare-metal-age-google-from-bare-metal-to-serverless.jpg)
...
![1995 — The invention of web hosting](/content/images/2017/12/geocities-invention-of-web-hosting-from-bare-metal-to-serverless.jpg)
...
![1997 Ian Foster and the idea of Grid Computing](/content/images/2017/12/ian-foster-grid-computing-from-bare-metal-to-serverless.jpg)

Around 1997, thanks to the astonishing work of the University of Chicago and the Argonne National Laboratory, that together founded the [Globus Alliance](https://en.m.wikipedia.org/wiki/Globus_Alliance), the idea of *Grid computing* was formalized.

In a paper titled *"Globus: A Metacomputing Infrastructure Toolkit"* by Ian Foster (in the picture) and Carl Kesselman, a new idea of computing, defined *metacomputing*, was formalized and finally made famous:
...
![1999 — Salesforce introduces the concept of Software as a Service (SaaS)](/content/images/2017/12/marc-benioff-salesforce-software-as-a-service-from-bare-metal-to-serverless.jpg)
...
![2001 — VMWare releases ESXi, "server virtualization" becomes a thing](/content/images/2017/12/VMware-BIOS-server-virtualization-from-bare-metal-to-serverless.jpg)
...
![2002-2006 — AWS is born (IaaS), people talk about "Cloud computing"](/content/images/2017/12/andy-jassy-aws-reinvent-infrastructure-as-a-service-from-bare-metal-to-serverless.jpg)
...
Only after the 3rd launch, AWS found the right proposition to developers and started to build up significant traction. This successful launch defined the term *Infrastructure as a Service*.
...
![2009 — Heroku and the invention of the "Platform as a Service"](/content/images/2017/12/adam-wiggins-heroku-founder-from-bare-metal-to-serverless.jpg)

Heroku was developed by James Lindenbaum, Adam Wiggins (in the picture) and Orion Henry in 2009.

Heroku was originally born as an attempt to create an online editor for Ruby on Rails, but it quickly found it's *product-market fit* as a complete platform to deploy and scale Ruby web applications. Support later increasingly extended to all the main languages and frameworks in the market.
...
![2011 — Envolve/Firebase, real-time database as a service](/content/images/2017/12/firebase-founder-james-tamplin-from-bare-metal-to-serverless.jpg)
...
![2012 — Parse.com and the first Backend as a Service (BaaS)](/content/images/2017/12/ilya-sukhar-parse-com-founder-from-bare-metal-to-serverless.jpg)

Parse was founded in 2011 by Tikhon Bernstam, Ilya Sukhar (in the picture), James Yu, and Kevin Lacker.

The firm produced a series of back-end tools for mobile developers to store data in the cloud, manage identity log-ins, handle push notifications and run custom code in the cloud. This kind of product was known at the time as *Backend as a Service* (Baas).
...
![2013 — Docker, "containers are better than virtual machines"](/content/images/2017/12/solomon-hykes-dockercon-docker-container-from-bare-metal-to-serverless.jpg)
...
![2013-2015 — Kubernetes / Swarm / Nomad / CoreOs (containers at scale)](/content/images/2017/12/google-cloud-kubernetes-from-bare-metal-to-serverless.jpg)
...
![](/content/images/2017/12/aws-lambda-launch-faas-function-as-a-service-from-bare-metal-to-serverless.jpg)
...
[![You told me there were no servers!](/content/images/2017/12/commitstrip-strip-severless-from-bare-metal-to-serverless.jpg)](http://loige.link/serverless-commitstrip)
...
![Serverless through abstractions](/content/images/2017/12/serverless-abstraction-levels-fullstack-python-from-bare-metal-to-serverless.png)

<small>Picture from [fullstackpython.com](https://www.fullstackpython.com/serverless.html)</small>

In this picture, Matt Makai from *fullstackpython*, illustrates exactly how levels of abstraction and platforms were created to keep removing complexity and leave more time for the actual business value that the app has to provide.
