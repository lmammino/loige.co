...
import Image1 from './how-to-make-a-react-spa-invite-only.png'
...
<Picture src={Image1} widths={[200, 400, 800]} sizes="(max-width: 800px) 100vw, 800px" alt="Illustration showing how to make a React SPA built with Next.js invite-only using AirTable as a data storage" />
