      ...
      <ResponsiveWrapper>
        <ArticleContainer style={{ minHeight: '80vh' }}>
          ...
          <p>
            ...
            cyberattackers and speeding-up incident response. I love the
            fullstack web, Node.js and Serverless so I co-authored the book
            "Node.js design patterns" (http://amzn.to/1ZF279B), launched
            fstack.link (a semi-automated newsletter for Fullstack developers)
            and Serverlesslab.com (in-house serverless training).
          </p>
